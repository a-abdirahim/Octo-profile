...
const getTopStarred = async () => {
  const response = await fetch(`https://api.github.com/users/jonasschmedtmann/repos`);
    const repositories = await response.json();
...
const getMostStarred = async () => {
   ...
   const response = await fetch(`https://api.github.com/users/jonasschmedtmann/repos?per_page=1000`);
